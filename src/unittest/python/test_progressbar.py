...
class TestProgressBar(unittest.TestCase):
    ...
    @patch('mp4ansi.progressbar.cursor')
    @patch('mp4ansi.progressbar.sys.stderr')
    ...
    @patch('mp4ansi.progressbar.sys.stderr')
    def test__print_Should_CallExpected_When_TtyAttributeTotal(self, stderr_patch, print_patch, *patches):
        stderr_patch.isatty.return_value = True
        pb = ProgressBar(aware=False)
        pb._print('total')
    ...
    @patch('builtins.print')
    @patch('mp4ansi.progressbar.sys.stderr')
    def test__print_Should_CallExpected_When_TtyAttributeCount(self, stderr_patch, print_patch, *patches):
        stderr_patch.isatty.return_value = True
        pb = ProgressBar(aware=False)
        pb._print('count')
        stderr_patch.flush.assert_called_once_with()
